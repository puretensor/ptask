...
**Status:** v1.0.5 — Rust workspace is production-active on the PureTensor fleet. See [`docs/master-plan.md`](docs/master-plan.md) for the historical 12-phase build plan and current follow-ups.
