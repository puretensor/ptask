...
| MCP (agents) | `pt mcp` (stdio) or `/mcp` mount on the server | 20 tools; bearer-gated HTTP for HAL, scoped REST tokens for other agents — [`docs/agent-surface.md`](docs/agent-surface.md) |
