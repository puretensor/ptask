...
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "add" -d 'Create a new task'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "list" -d 'List tasks'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "done" -d 'Mark a task done (by PT-N or title substring)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "next" -d 'Show ready-to-start tasks (all dependencies done)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "view" -d 'Manage saved views'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "tui" -d 'Launch the terminal UI (ratatui)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "serve" -d 'Run the HTTP server (sync API, capture, webhooks, metrics)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "bot" -d 'Run the Telegram bot (teloxide long-poll)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "branch" -d 'Print a Linear-style branch name for a task'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "distill" -d 'Run the distillation pipeline (Python subprocess shim until v0.9)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "accountability" -d 'Run one accountability cycle (escalation + Telegram/email)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "scoring" -d 'Recompute composite priority scores for all active tasks'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "remote" -d 'Talk to a remote canonical `pt serve` (no local DB)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "backfill" -d 'One-shot backfill PT-N for any tasks lacking one'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "gen-manpage" -d 'Generate the `pt(1)` manpage to stdout'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "gen-completions" -d 'Generate shell completions (bash/zsh/fish) to stdout'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
