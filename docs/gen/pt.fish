...
complete -c pt -n "__fish_pt_needs_command" -f -a "bot" -d 'Run the Telegram bot (teloxide long-poll)'
...
complete -c pt -n "__fish_pt_using_subcommand remote; and not __fish_seen_subcommand_from add list done priority edit reopen show help" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand remote; and not __fish_seen_subcommand_from add list done priority edit reopen show help" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand remote; and not __fish_seen_subcommand_from add list done priority edit reopen show help" -f -a "add" -d '`pt remote add "..."` — create a task on the canonical host without opening a local DB. Uses PTASK_SYNC_URL (default https://ptask.ts.puretensor.local)'
complete -c pt -n "__fish_pt_using_subcommand remote; and not __fish_seen_subcommand_from add list done priority edit reopen show help" -f -a "list" -d '`pt remote list` — fetch the live task set from the canonical host'
complete -c pt -n "__fish_pt_using_subcommand remote; and not __fish_seen_subcommand_from add list done priority edit reopen show help" -f -a "done" -d '`pt remote done <query>` — mark a task done by PT-N or title substring'
complete -c pt -n "__fish_pt_using_subcommand remote; and not __fish_seen_subcommand_from add list done priority edit reopen show help" -f -a "priority" -d '`pt remote priority <query> <level>` — set priority on the canonical host'
complete -c pt -n "__fish_pt_using_subcommand remote; and not __fish_seen_subcommand_from add list done priority edit reopen show help" -f -a "edit" -d '`pt remote edit <query> --deadline <iso> | --clear-deadline`'
complete -c pt -n "__fish_pt_using_subcommand remote; and not __fish_seen_subcommand_from add list done priority edit reopen show help" -f -a "reopen" -d '`pt remote reopen <query>` — flip a done/dismissed task back to pending'
complete -c pt -n "__fish_pt_using_subcommand remote; and not __fish_seen_subcommand_from add list done priority edit reopen show help" -f -a "show" -d '`pt remote show <query>` — print one task\'s full row (read-only)'
complete -c pt -n "__fish_pt_using_subcommand remote; and not __fish_seen_subcommand_from add list done priority edit reopen show help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c pt -n "__fish_pt_using_subcommand remote; and __fish_seen_subcommand_from help" -f -a "show" -d '`pt remote show <query>` — print one task\'s full row (read-only)'
...
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "add" -d 'Create a new task'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "list" -d 'List tasks'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "done" -d 'Mark a task done (by PT-N or title substring)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "priority" -d 'Promote/demote a task\'s priority (critical|urgent|high|normal|low or 1..=5)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "edit" -d 'Edit task fields'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "reopen" -d 'Reopen a completed/dismissed task (status → pending)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "next" -d 'Show ready-to-start tasks (all dependencies done)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "view" -d 'Manage saved views'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "tui" -d 'Launch the terminal UI (ratatui)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "serve" -d 'Run the HTTP server (sync API, capture, webhooks, metrics)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "bot" -d 'Run the Telegram bot (teloxide long-poll)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "branch" -d 'Print a Linear-style branch name for a task'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "distill" -d 'Run the distillation pipeline (Python subprocess shim until v0.9)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "accountability" -d 'Run one accountability cycle (escalation + Telegram/email)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "scoring" -d 'Recompute composite priority scores for all active tasks'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "remote" -d 'Talk to a remote canonical `pt serve` (no local DB)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "backfill" -d 'One-shot backfill PT-N for any tasks lacking one'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "gen-manpage" -d 'Generate the `pt(1)` manpage to stdout'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "gen-completions" -d 'Generate shell completions (bash/zsh/fish) to stdout'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen next view tui serve bot branch distill accountability scoring remote backfill gen-manpage gen-completions help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from remote" -f -a "show" -d '`pt remote show <query>` — print one task\'s full row (read-only)'
