...
complete -c pt -n "__fish_pt_needs_command" -f -a "context" -d 'Markdown worker brief: title, why-chain, blockers'
...
complete -c pt -n "__fish_pt_needs_command" -f -a "promote" -d 'Promote an investigation to implementation: kind scout → ship on the SAME row (never close + reopen a duplicate)'
complete -c pt -n "__fish_pt_needs_command" -f -a "kind" -d 'Set a task\'s kind (scout|ship) and optional deliverable'
...
complete -c pt -n "__fish_pt_needs_command" -f -a "approval" -d 'Approval inbox: agents request, the operator decides, executors consume'
complete -c pt -n "__fish_pt_needs_command" -f -a "goal" -d 'Goal tree: mission ancestry for tasks'
complete -c pt -n "__fish_pt_needs_command" -f -a "approve" -d 'Approve a pending approval request (operator only)'
complete -c pt -n "__fish_pt_needs_command" -f -a "reject" -d 'Reject a pending approval request (operator only)'
...
complete -c pt -n "__fish_pt_using_subcommand add" -l kind -d 'Task shape: scout (investigation) or ship (implementation, default)' -r
...
complete -c pt -n "__fish_pt_using_subcommand context" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand context" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand context" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand context" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand context" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand context" -s h -l help -d 'Print help'
...
complete -c pt -n "__fish_pt_using_subcommand approval; and not __fish_seen_subcommand_from request list show payload withdraw verify consume expire notify decide help" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and not __fish_seen_subcommand_from request list show payload withdraw verify consume expire notify decide help" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and not __fish_seen_subcommand_from request list show payload withdraw verify consume expire notify decide help" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand approval; and not __fish_seen_subcommand_from request list show payload withdraw verify consume expire notify decide help" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand approval; and not __fish_seen_subcommand_from request list show payload withdraw verify consume expire notify decide help" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand approval; and not __fish_seen_subcommand_from request list show payload withdraw verify consume expire notify decide help" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand approval; and not __fish_seen_subcommand_from request list show payload withdraw verify consume expire notify decide help" -f -a "request" -d 'Request operator approval for an exact payload'
complete -c pt -n "__fish_pt_using_subcommand approval; and not __fish_seen_subcommand_from request list show payload withdraw verify consume expire notify decide help" -f -a "list" -d 'List approvals (default: pending, oldest first)'
complete -c pt -n "__fish_pt_using_subcommand approval; and not __fish_seen_subcommand_from request list show payload withdraw verify consume expire notify decide help" -f -a "show" -d 'Show one approval, including journal events'
complete -c pt -n "__fish_pt_using_subcommand approval; and not __fish_seen_subcommand_from request list show payload withdraw verify consume expire notify decide help" -f -a "payload" -d 'Write the stored payload bytes to stdout'
complete -c pt -n "__fish_pt_using_subcommand approval; and not __fish_seen_subcommand_from request list show payload withdraw verify consume expire notify decide help" -f -a "withdraw" -d 'Withdraw a pending request (requester only)'
complete -c pt -n "__fish_pt_using_subcommand approval; and not __fish_seen_subcommand_from request list show payload withdraw verify consume expire notify decide help" -f -a "verify" -d 'Check that an approval is approved and the payload still matches'
complete -c pt -n "__fish_pt_using_subcommand approval; and not __fish_seen_subcommand_from request list show payload withdraw verify consume expire notify decide help" -f -a "consume" -d 'Verify and latch the approval as consumed (exactly once)'
complete -c pt -n "__fish_pt_using_subcommand approval; and not __fish_seen_subcommand_from request list show payload withdraw verify consume expire notify decide help" -f -a "expire" -d 'Mark pending rows past expires_at as expired'
complete -c pt -n "__fish_pt_using_subcommand approval; and not __fish_seen_subcommand_from request list show payload withdraw verify consume expire notify decide help" -f -a "notify" -d 'Send Telegram pings for pending un-notified requests'
complete -c pt -n "__fish_pt_using_subcommand approval; and not __fish_seen_subcommand_from request list show payload withdraw verify consume expire notify decide help" -f -a "decide" -d 'Approve or reject a pending request (operator only)'
complete -c pt -n "__fish_pt_using_subcommand approval; and not __fish_seen_subcommand_from request list show payload withdraw verify consume expire notify decide help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from request" -l kind -d 'email | ebay | spend | destroy | external | budget | other' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from request" -l title -d 'Short operator-facing title' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from request" -l note -d 'Requester\'s note (always labelled as such; never mixed into preview)' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from request" -l note-file -d 'Read the requester\'s note from a file' -r -F
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from request" -l payload-file -d 'Store this file as the bound payload (max 256 KiB)' -r -F
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from request" -l payload-json -d 'Store canonical JSON as the bound payload' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from request" -l digest -d 'Bind to a digest without storing the payload' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from request" -l task -d 'Optional linked task (PT-n)' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from request" -l expires-in -d 'Auto-expire after this duration, e.g. 1s, 15m, 2h, 7d' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from request" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from request" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from request" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from request" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from request" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from request" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from list" -l status -d 'pending (default) | approved | rejected | withdrawn | expired | all' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from list" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from list" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from list" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from list" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from list" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from list" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from show" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from show" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from show" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from show" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from show" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from show" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from payload" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from payload" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from payload" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from payload" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from payload" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from payload" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from withdraw" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from withdraw" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from withdraw" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from withdraw" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from withdraw" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from withdraw" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from verify" -l payload-file -r -F
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from verify" -l payload-json -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from verify" -l digest -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from verify" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from verify" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from verify" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from verify" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from verify" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from verify" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from consume" -l payload-file -r -F
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from consume" -l payload-json -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from consume" -l digest -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from consume" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from consume" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from consume" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from consume" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from consume" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from consume" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from expire" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from expire" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from expire" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from expire" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from expire" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from expire" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from notify" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from notify" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from notify" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from notify" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from notify" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from notify" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from decide" -l note -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from decide" -l via -r -f -a "dashboard\t''"
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from decide" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from decide" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
...
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from help" -f -a "request" -d 'Request operator approval for an exact payload'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from help" -f -a "list" -d 'List approvals (default: pending, oldest first)'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from help" -f -a "show" -d 'Show one approval, including journal events'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from help" -f -a "payload" -d 'Write the stored payload bytes to stdout'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from help" -f -a "withdraw" -d 'Withdraw a pending request (requester only)'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from help" -f -a "verify" -d 'Check that an approval is approved and the payload still matches'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from help" -f -a "consume" -d 'Verify and latch the approval as consumed (exactly once)'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from help" -f -a "expire" -d 'Mark pending rows past expires_at as expired'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from help" -f -a "notify" -d 'Send Telegram pings for pending un-notified requests'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from help" -f -a "decide" -d 'Approve or reject a pending request (operator only)'
complete -c pt -n "__fish_pt_using_subcommand approval; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c pt -n "__fish_pt_using_subcommand goal; and not __fish_seen_subcommand_from add ls show link unlink set-parent done abandon orphans help" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and not __fish_seen_subcommand_from add ls show link unlink set-parent done abandon orphans help" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and not __fish_seen_subcommand_from add ls show link unlink set-parent done abandon orphans help" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand goal; and not __fish_seen_subcommand_from add ls show link unlink set-parent done abandon orphans help" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand goal; and not __fish_seen_subcommand_from add ls show link unlink set-parent done abandon orphans help" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand goal; and not __fish_seen_subcommand_from add ls show link unlink set-parent done abandon orphans help" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand goal; and not __fish_seen_subcommand_from add ls show link unlink set-parent done abandon orphans help" -f -a "add" -d 'Create a goal'
complete -c pt -n "__fish_pt_using_subcommand goal; and not __fish_seen_subcommand_from add ls show link unlink set-parent done abandon orphans help" -f -a "ls" -d 'List goals in tree order (parent before children, siblings by seq)'
complete -c pt -n "__fish_pt_using_subcommand goal; and not __fish_seen_subcommand_from add ls show link unlink set-parent done abandon orphans help" -f -a "show" -d 'Show one goal: ancestors, children, tasks, subtree rollup'
complete -c pt -n "__fish_pt_using_subcommand goal; and not __fish_seen_subcommand_from add ls show link unlink set-parent done abandon orphans help" -f -a "link" -d 'Direct-link a task to a goal'
complete -c pt -n "__fish_pt_using_subcommand goal; and not __fish_seen_subcommand_from add ls show link unlink set-parent done abandon orphans help" -f -a "unlink" -d 'Remove a task\'s direct goal link (inheritance remains)'
complete -c pt -n "__fish_pt_using_subcommand goal; and not __fish_seen_subcommand_from add ls show link unlink set-parent done abandon orphans help" -f -a "set-parent" -d 'Move a goal under a new parent (rejects self and cycles)'
complete -c pt -n "__fish_pt_using_subcommand goal; and not __fish_seen_subcommand_from add ls show link unlink set-parent done abandon orphans help" -f -a "done" -d 'Mark a goal achieved'
complete -c pt -n "__fish_pt_using_subcommand goal; and not __fish_seen_subcommand_from add ls show link unlink set-parent done abandon orphans help" -f -a "abandon" -d 'Mark a goal abandoned'
complete -c pt -n "__fish_pt_using_subcommand goal; and not __fish_seen_subcommand_from add ls show link unlink set-parent done abandon orphans help" -f -a "orphans" -d 'List open tasks with no effective goal'
complete -c pt -n "__fish_pt_using_subcommand goal; and not __fish_seen_subcommand_from add ls show link unlink set-parent done abandon orphans help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from add" -l why -d 'Why this goal exists' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from add" -l parent -d 'Parent goal (`G-n`)' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from add" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from add" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from add" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from add" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from add" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from add" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from ls" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from ls" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from ls" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from ls" -l all -d 'Include achieved and abandoned goals'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from ls" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from ls" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from ls" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from show" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from show" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from show" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from show" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from show" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from show" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from link" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from link" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from link" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from link" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from link" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from link" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from unlink" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from unlink" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from unlink" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from unlink" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from unlink" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from unlink" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from set-parent" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from set-parent" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from set-parent" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from set-parent" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from set-parent" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from set-parent" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from done" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from done" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from done" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from done" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from done" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from done" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from abandon" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from abandon" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from abandon" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from abandon" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from abandon" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from abandon" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from orphans" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from orphans" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from orphans" -l color -d 'Colour: auto (TTY only; honours NO_COLOR and PT_COLOR=always|never), always, or never' -r -f -a "auto\t''
always\t''
never\t''"
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from orphans" -l json -d 'Emit machine-readable JSON instead of human text (task-facing verbs)'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from orphans" -l no-color -d 'Plain output — shorthand for `--color never`'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from orphans" -s h -l help -d 'Print help'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from help" -f -a "add" -d 'Create a goal'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from help" -f -a "ls" -d 'List goals in tree order (parent before children, siblings by seq)'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from help" -f -a "show" -d 'Show one goal: ancestors, children, tasks, subtree rollup'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from help" -f -a "link" -d 'Direct-link a task to a goal'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from help" -f -a "unlink" -d 'Remove a task\'s direct goal link (inheritance remains)'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from help" -f -a "set-parent" -d 'Move a goal under a new parent (rejects self and cycles)'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from help" -f -a "done" -d 'Mark a goal achieved'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from help" -f -a "abandon" -d 'Mark a goal abandoned'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from help" -f -a "orphans" -d 'List open tasks with no effective goal'
complete -c pt -n "__fish_pt_using_subcommand goal; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c pt -n "__fish_pt_using_subcommand approve" -l note -r
complete -c pt -n "__fish_pt_using_subcommand approve" -l via -d 'Record decided_via=dashboard (also allows a non-TTY stdin)' -r -f -a "dashboard\t''"
complete -c pt -n "__fish_pt_using_subcommand approve" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand approve" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
...
complete -c pt -n "__fish_pt_using_subcommand reject" -l note -r
complete -c pt -n "__fish_pt_using_subcommand reject" -l via -d 'Record decided_via=dashboard (also allows a non-TTY stdin)' -r -f -a "dashboard\t''"
complete -c pt -n "__fish_pt_using_subcommand reject" -l db -d 'Override the SQLite path (default: $PTASK_DB or ~/puretensor-tasks/tasks.db)' -r
complete -c pt -n "__fish_pt_using_subcommand reject" -l idempotency-key -d 'Idempotency key recorded with the mutation\'s event — a retried command with the same key returns ok without re-applying' -r
...
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "add" -d 'Create a new task'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "list" -d 'List tasks'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "done" -d 'Mark a task done (by PT-N or title substring)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "priority" -d 'Promote/demote a task\'s priority (critical|urgent|high|normal|low or 1..=5)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "edit" -d 'Edit task fields'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "reopen" -d 'Reopen a completed/dismissed task (status → pending)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "show" -d 'Show one task\'s full row + side-table detail'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "context" -d 'Markdown worker brief: title, why-chain, blockers'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "dismiss" -d 'Dismiss a task (soft close, status → dismissed; reversible via reopen)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "rm" -d 'Delete a task permanently (hard delete + tombstone)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "next" -d 'Show ready-to-start tasks (all dependencies done)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "plan" -d 'Advisory day plan: fit the ready queue into calendar free/busy (dry-run unless --write). Reads free slots via gcalendar.py; --write adds tentative events to our own calendar only'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "view" -d 'Manage saved views'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "tui" -d 'Launch the terminal UI (ratatui)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "serve" -d 'Run the HTTP server (sync API, capture, webhooks, metrics)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "bot" -d 'Run the Telegram bot (Bot API long-poll)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "mcp" -d 'Serve the MCP server over stdio (agent-native tool surface)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "digest" -d 'Session-priming digest: recent done/dismissed/created + ready queue'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "export" -d 'Export tasks/links/labels as JSONL (optionally git-commit the export)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "delegate" -d 'Print the operator-gated delegation command for a task (skeleton)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "branch" -d 'Print a Linear-style branch name for a task'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "distill" -d 'Run the native Rust distillation pipeline'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "accountability" -d 'Run one accountability cycle (escalation + Telegram/email)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "scoring" -d 'Recompute composite priority scores for all active tasks'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "remote" -d 'Talk to a remote canonical `pt serve` (no local DB)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "promote" -d 'Promote an investigation to implementation: kind scout → ship on the SAME row (never close + reopen a duplicate)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "kind" -d 'Set a task\'s kind (scout|ship) and optional deliverable'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "start" -d 'Mark a task in progress (you\'re actively working it)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "snooze" -d 'Snooze a task until a date — it leaves `pt next` and reminders, then wakes to todo automatically'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "reap" -d 'Reap stale machine-generated tasks (incident >7d idle, distilled >30d idle) — soft-dismiss, reversible via `pt reopen`'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "depend" -d 'Manage dependency edges: PT-A depends on PT-B'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "review" -d 'Interactive review sweep: stale, snoozed-expired, and triage items'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "search" -d 'Full-text search over titles + descriptions (FTS5)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "why" -d 'Explain a task\'s composite score: components, weights, rank'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "bulk" -d 'Apply one action to every task matching a filter DSL expression'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "log" -d 'Show a task\'s attributed event history (who did what, via which surface)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "undo" -d 'Reverse the most recent undoable mutation (done/dismiss/create)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "token" -d 'Manage named scoped API tokens (create/list/revoke)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "approval" -d 'Approval inbox: agents request, the operator decides, executors consume'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "goal" -d 'Goal tree: mission ancestry for tasks'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "approve" -d 'Approve a pending approval request (operator only)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "reject" -d 'Reject a pending approval request (operator only)'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "backfill" -d 'One-shot backfill PT-N for any tasks lacking one'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "gen-manpage" -d 'Generate the `pt(1)` manpage to stdout'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "gen-completions" -d 'Generate shell completions (bash/zsh/fish) to stdout'
complete -c pt -n "__fish_pt_using_subcommand help; and not __fish_seen_subcommand_from add list done priority edit reopen show context dismiss rm next plan view tui serve bot mcp digest export delegate branch distill accountability scoring remote promote kind start snooze reap depend review search why bulk log undo token approval goal approve reject backfill gen-manpage gen-completions help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from remote" -f -a "add" -d '`pt remote add "..."` — create a task on the canonical host without opening a local DB. Uses PTASK_SYNC_URL (default http://127.0.0.1:9501)'
...
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from approval" -f -a "request" -d 'Request operator approval for an exact payload'
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from approval" -f -a "list" -d 'List approvals (default: pending, oldest first)'
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from approval" -f -a "show" -d 'Show one approval, including journal events'
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from approval" -f -a "payload" -d 'Write the stored payload bytes to stdout'
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from approval" -f -a "withdraw" -d 'Withdraw a pending request (requester only)'
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from approval" -f -a "verify" -d 'Check that an approval is approved and the payload still matches'
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from approval" -f -a "consume" -d 'Verify and latch the approval as consumed (exactly once)'
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from approval" -f -a "expire" -d 'Mark pending rows past expires_at as expired'
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from approval" -f -a "notify" -d 'Send Telegram pings for pending un-notified requests'
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from approval" -f -a "decide" -d 'Approve or reject a pending request (operator only)'
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from goal" -f -a "add" -d 'Create a goal'
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from goal" -f -a "ls" -d 'List goals in tree order (parent before children, siblings by seq)'
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from goal" -f -a "show" -d 'Show one goal: ancestors, children, tasks, subtree rollup'
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from goal" -f -a "link" -d 'Direct-link a task to a goal'
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from goal" -f -a "unlink" -d 'Remove a task\'s direct goal link (inheritance remains)'
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from goal" -f -a "set-parent" -d 'Move a goal under a new parent (rejects self and cycles)'
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from goal" -f -a "done" -d 'Mark a goal achieved'
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from goal" -f -a "abandon" -d 'Mark a goal abandoned'
complete -c pt -n "__fish_pt_using_subcommand help; and __fish_seen_subcommand_from goal" -f -a "orphans" -d 'List open tasks with no effective goal'
